...
### [2026-07-01] 1pdf1product-operational-rule
...
### [2026-07-01] expiration-alert-plan

- 日付: [2026-07-01]
- タスク: 期限接近通知・期限管理シートの実装計画（FR-NTF-003 / FR-SHT-003）
- エラーと解決: なし
- ユーザー指摘: Slack 月初+7日前。商品DB+期限管理二層。コード未着手